...
public: \
		...
		{ \
 		...
 		\
			...
			temp_func->RegisterFunction(this, &SomeTestClass::test_function_0); \
			temp_func = GetFunction("test_function_1"); \
			temp_func->RegisterFunction(this, &SomeTestClass::test_function_1); \
		}
